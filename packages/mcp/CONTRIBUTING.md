# Contributing to @lancedb/claude-context-mcp
...
```bash
claude mcp add claude-context -e OPENAI_API_KEY=sk-your-openai-api-key -e LANCEDB_PATH=./.lancedb -- node PATH_TO_CLAUDECONTEXT/packages/mcp/dist/index.js
```
